...
func (dao *AlipayMerchantAppConfigDao) GetExtWhereKeys() []string {
	return dao.exWhereArr
}

func (dao *AlipayMerchantAppConfigDao) IsIgnoreCache() bool {
	return dao.ignoreCache
}

func (dao *AlipayMerchantAppConfigDao) IgnoreCache() dao_interface.IDao {
	dao.ignoreCache = true
	return dao
}
func (dao *AlipayMerchantAppConfigDao) IgnoreExtModel(whereKey ...string) dao_interface.IDao {
