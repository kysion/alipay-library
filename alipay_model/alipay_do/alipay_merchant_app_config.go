...
// AlipayMerchantAppConfig is the golang structure of table alipay_merchant_app_config for DAO operations like Where/Data.
type AlipayMerchantAppConfig struct {
	g.Meta                  `orm:"table:alipay_merchant_app_config, do:true"`
	Id                      interface{} // 商家id
