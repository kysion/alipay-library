...
require (
	github.com/SupenBysz/gf-admin-community v0.7.24
	github.com/SupenBysz/gf-admin-company-modules v0.7.63
...
require (
	...
	github.com/gogf/gf/contrib/nosql/redis/v2 v2.7.2 // indirect
	...
	github.com/kysion/oss-library v0.1.16 // indirect
	github.com/kysion/sms-library v0.1.14 // indirect
