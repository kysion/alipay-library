...
type SubmitAppVersionAuditReq struct {
	g.Meta `path:"/:appId/submitAppVersionAudit" method:"get" summary:"提交应用版本审核" tags:"阿里云小程序管理"`
	SubmitVersion
}
...
type CancelAppVersionAuditReq struct {
	g.Meta     `path:"/:appId/cancelAppVersionAudit" method:"get" summary:"撤销应用版本审核" tags:"阿里云小程序管理"`
	AppVersion string `json:"app_version" dc:"版本号"`
}

type CancelAppVersionReq struct {
	g.Meta     `path:"/:appId/cancelAppVersion" method:"get" summary:"退回开发版本" tags:"阿里云小程序管理"`
	AppVersion string `json:"app_version" dc:"版本号"`
}

type AppOnlineReq struct {
	g.Meta     `path:"/:appId/appOnline" method:"get" summary:"小程序上架" tags:"阿里云小程序管理"`
	AppVersion string `json:"app_version" dc:"版本号"`
}

type AppOfflineReq struct {
	g.Meta     `path:"/:appId/appOffline" method:"get" summary:"小程序下架" tags:"阿里云小程序管理"`
	AppVersion string `json:"app_version" dc:"版本号"`
}

type QueryAppVersionListReq struct {
	g.Meta `path:"/:appId/queryAppVersionList" method:"post" summary:"小程序版本列表查询" tags:"阿里云小程序管理"`
	// query请求URL传参参数
...
type GetAppVersionDetailReq struct {
	g.Meta     `path:"/:appId/getAppVersionDetail" method:"post" summary:"小程序版本详情查询" tags:"阿里云小程序管理"`
	AppVersion string `json:"app_version" dc:"版本号"`
}
