...
func (c *cAlipayConsumerConfig) AuditConsumer(ctx context.Context, req *alipay_consumer_v1.AuditConsumer) (string, error) {
	ret, err := service.UserCertity().AuditConsumer(ctx, &req.OpenInitialize)
	return ret, err
}
